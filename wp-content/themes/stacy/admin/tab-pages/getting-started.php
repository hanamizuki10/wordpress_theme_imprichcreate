...
<div id="getting_started" class="stacy-tab-pane active">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="stacy-info-title text-center"><?php echo __('About the Stacy theme','stacy'); ?><?php if( !empty($stacy['Version']) ): ?> <sup id="stacy-theme-version"><?php echo esc_attr( $stacy['Version'] ); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
				<img class="img-responsive" src="<?php echo esc_url( get_stylesheet_directory_uri() ) . '/admin/img/stacy.png'; ?>" alt="<?php esc_html_e( 'Stacy theme', 'stacy' ); ?>" />
				</div>
			</div>	
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Lite Demo','stacy'); ?></p></a>
					...
					<p class="info-text"><?php echo __('PRO Demo','stacy'); ?></p></a>
			...
			<div class="col-md-6">	
				...
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Your feedback is valuable to us','stacy'); ?></p></a>
					...
					<p class="info-text"><?php echo __('Premium Theme Support','stacy'); ?></p></a>
				</div>
			</div>
			...
			<div class="col-md-6">	
				...
				<div class="stacy-tab-pane-half stacy-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Premium Theme Details','stacy'); ?></p></a>
