...
if (!class_exists('SpiceThemes_About_Page')) {
	...
	public function stacy_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_stacy-welcome' == $hook_suffix ) {
			...
			wp_enqueue_style( 'stacy-info-screen-css', get_stylesheet_directory_uri() . '/admin/assets/css/welcome.css' );
			
			wp_enqueue_style( 'stacy-info-css', get_stylesheet_directory_uri() . '/admin/assets/css/bootstrap.css' );
			
			wp_enqueue_style('stacy-theme-info-style', get_stylesheet_directory_uri() . '/admin/assets/css/welcome-page-styles.css');
			
			wp_enqueue_style('welcome_customizer', get_stylesheet_directory_uri() . '/admin/assets/css/welcome_customizer.css');
			wp_enqueue_script('plugin-install');
			wp_enqueue_script('updates');
			wp_enqueue_script('stacy-companion-install', get_stylesheet_directory_uri() . '/admin/assets/js/plugin-install.js', array('jquery'));
			wp_enqueue_script('stacy-ajax', get_stylesheet_directory_uri() . '/admin/assets/js/ajax.js', array('jquery'));
	...
	public function stacy_scripts_for_customizer() {
		...
		wp_enqueue_style( 'stacy-info-screen-customizer-css', get_stylesheet_directory_uri() . '/admin/assets/css/welcome_customizer.css' );
		wp_enqueue_script( 'stacy-info-screen-customizer-js', get_stylesheet_directory_uri() . '/admin/assets/js/welcome_customizer.js', array('jquery'), '20120206', true );
		...
		public function welcome_admin_notice() {
			...
			<div class="updated notice is-dismissible stacy-notice">
				...
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=stacy-welcome' ) ); ?>" class="button button-blue-secondary button_stacy" style="text-decoration: none;"><?php _e('Get started with Stacy','stacy'); ?></a></p>
			</div>
			<?php
		}
	  ...
	  <div class="container-fluid">
		<div class="row">
		<div class="col-md-12">
			<div class="wrap theme-info-wrap stacy-wrap">
	...
	/**
		...
		public function stacy_changelog() {
			...
			<div class="wrap about-wrap">
				...
				<?php
				$changelog_file = apply_filters( 'stacy_changelog_file', get_stylesheet_directory() . '/changelog.txt' );
