...
<section class="gallery-page">
	...
	<nav class="gallery-navs">
		<ul>
			<li><a href="<?php echo esc_url( home_url( '/gallery/' ) );?>">ALL</a></li>
			<?php
				// メニューカテゴリーのリストを出力
				$args = array(
					'taxonomy' => 'gallerycat', //menucatタクソノミーを指定
				...
				<div class="gallery-block">
					...
					<header class="gallery-header">
						<div class="gallery-meta">
							<span class="date"><time class="entry-date"><?php the_time( 'Y年n月j日 H:i' );?></time></span>
							<div class="categories-links info">
							<?php
